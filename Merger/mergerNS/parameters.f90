...
MODULE parameters
  ...
  INTEGER,PARAMETER::nmax = n1*2    !Maximum number of particles
  ...
  INTEGER,PARAMETER::nodes=6         !Amount of nodes.
  INTEGER,PARAMETER::dim = 3         !Spatial imensions
  INTEGER,PARAMETER::nnl = 50000     !Iterations
  ...
  LOGICAL,PARAMETER::gwrad=.true.         !Calculate gravitational wave emission
  ...
  CHARACTER*20,PARAMETER::inputfile='neutron_star'  !Input file (first star)
  CHARACTER*20,PARAMETER::inputfile2='s2.020600'    !Input file (second star) for Restart
  CHARACTER*100,PARAMETER::comments=&
       &'Neutron star relaxation'
  !EOS
  DOUBLE PRECISION, PARAMETER::gamma=5.d0/3.d0
  INTEGER,PARAMETER::eos = 5 !Choose EOS
